import { delay, mapToRecord, mapToRecordAsync } from '../src';
...
describe('record map:', () => {
    ...
    test('maps keys', () => {
        ...
        const map = mapToRecord(K1, key => String(key));
    ...
    test('maps functions', () => {
        ...
        const map = mapToRecord(K1, key => () => helper(key));
    ...
    test('maps async', async () => {
        ...
        const map = await mapToRecordAsync(K1, helper);
